...
import {GetConfig} from '../plugins/globalApi/global'
...
import {GetUserMoney} from '../plugins/personCenterApi/personCenter'
import {GetBankList} from '../plugins/personCenterApi/personCenter'
import {IsOpenFree} from '../plugins/trade/trade'
const createStore = ()=>{
  return new Vuex.Store({
    state:{
      mobile:'',
      //baseUrl:'https://www.gxw188.com',
      apiUrl:'http://47.100.235.158:8006/',
      userMoney:0,
      token:'',
      refreshToken:'',
      expires_in:'',
