...
export default function(context) {
  ...
  if (context.deviceType.type == "pc") {
     context.redirect(302,'http://139.224.113.43:8001/')    //301是永久重定向，如果你想随着设备类型改变一直变，请改为302
  } else {
    context.redirect(302,'http://139.224.113.43:8002/')    //301是永久重定向，如果你想随着设备类型改变一直变，请改为302
  }
}
