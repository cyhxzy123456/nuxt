    ...
    <div class="wrap">
      <div class="footer-top">
        <ul class="fl">
          <li>
            <h3>首页</h3>
            <nuxt-link to="/myTrade/myTrade">> 最新策略</nuxt-link>
            <nuxt-link to="/about/newsList">> 新闻资讯</nuxt-link>
          </li>
          <li v-show="day!=''">
            <h3>短期策略</h3>
            <nuxt-link :to="{path:'/myTrade/myTrade',query:{type:11}}">> 我的策略</nuxt-link>
            <nuxt-link to="/trade/trade" >> 短期策略</nuxt-link>
          </li>
          <li v-show="month!=''">
            <h3>长期策略</h3>
            <nuxt-link :to="{path:'/myTrade/myTrade',query:{type:12}}">> 我的策略</nuxt-link>
            <nuxt-link :to="{path:'/trade/trade',query:{type:12}}" > > 长期策略</nuxt-link>
          </li>
          <li v-show="mom!=''">
            <h3>微策略</h3>
            <nuxt-link :to="{path:'/myTrade/myTrade',query:{type:31}}">> 我的策略</nuxt-link>
            <nuxt-link :to="{path:'/trade/trade',query:{type:31}}">> 微策略</nuxt-link>
          </li>
          <li>
            <h3>关于我们</h3>
            <nuxt-link to="/about/newsList">> 新闻资讯</nuxt-link>
            <nuxt-link to="/about/aboutUs">> 平台优势</nuxt-link>
          </li>
          <li>
            <h3>帮助中心</h3>
            <nuxt-link to="/help/help" >帮助中心</nuxt-link>
          </li>
        </ul>
        <ul class="code fr">
          <li>
