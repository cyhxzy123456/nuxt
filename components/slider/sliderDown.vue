<template>
  <div class="box">
    <ul id="roll-ul">
      <nuxt-link @mouseover.native="clear" @mouseout.native="start"  :to="{name:'news-newsDetail',params:{id:item.id}}" tag="li" v-for="(item,index) in list" :key="index"  :class="{anim:animate==true}">
