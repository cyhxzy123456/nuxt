<template>
    <div>
      <div v-show="this.$store.getters.config.validBuy==0">
...
<script>
  import {GetMychoose} from '../../plugins/myTrade/myTrade'//添加自选
  import {AddMychoose} from '../../plugins/myTrade/myTrade'//添加自选
  import {DeleteMychoose} from '../../plugins/myTrade/myTrade'//删除自选
  import {SearchStock} from '../../plugins/myTrade/myTrade'//搜索
  import {Market} from '../../plugins/myTrade/myTrade'//买5卖5
  import {Buy} from '../../plugins/myTrade/myTrade'//买入
  import {BuyMom} from '../../plugins/myTrade/myTrade'//买入
  import {GetMaxMom} from '../../plugins/myTrade/myTrade'
  import {GetMax} from '../../plugins/myTrade/myTrade'
      ...
      watch:{
        ...
        stockCodeBuy:function(val){
          ...
          if(val.length == 6){
            ...
            that.$refs.tu.getQuotation(this.stockCodeBuy)
