...
<script>
  ...
  import {Sale} from '../../plugins/myTrade/myTrade'//买入
  import {SaleMom} from '../../plugins/myTrade/myTrade'//卖出
  import {GetPositionList} from '../../plugins/myTrade/myTrade'//持仓
  import {GetPositionListMom} from '../../plugins/myTrade/myTrade'//持仓mom
  import {GetMaxSale} from '../../plugins/myTrade/myTrade'//最大可卖
...
<style rel="stylesheet/less" lang="less" scoped>
  ...
  .buyLeft{
    li{position: relative;
      .down{background: url("../../assets/img/trade/btn-arrow-down.png") no-repeat;position: absolute;width:18px!important;height:18px;right:5px;top:10px;
