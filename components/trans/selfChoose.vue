      ...
      <div class="">
        <div class="chooseList">
          <table class="myChoose">
            <tbody>
            <tr>
              <th>股票代码</th><th>股票名称</th><th>股票现价</th><th>涨跌</th><th>涨幅</th><th>删除自选</th>
            </tr>
            <tr v-for="(item,index) in myChooseList" :key="index">
             ...
             <td v-text="item.stockCode"></td><td v-text="item.stockName"></td><td v-text="item.PriceCurrent"></td>
              ...
              <td class="pointer" @click="deleteChoose(item.id)">×</td>
            </tr>
            </tbody>
          </table>
...
<script>
  ...
  import {GetMychoose} from '../../plugins/myTrade/myTrade'//自选股池
