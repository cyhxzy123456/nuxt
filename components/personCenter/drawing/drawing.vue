      ...
      <div class="contRight">
        <div class="top">
          ...
          <div class="list">
            ...
            <nuxt-link to="/personCenter/setting" v-show="bankList == null">立即绑定</nuxt-link>
          </div>
          <div class="list">
            <span>提现密码：</span>
...
<script>
  ...
  import {CommitDraw} from '../../../plugins/personCenterApi/personCenter'//提现提交
  import {GetDrawInfo} from '../../../plugins/globalApi/global'
...
<style rel="stylesheet/less" lang="less" scoped>
  ...
  .contRight{
    ...
    .top{padding-left:154px;
      ...
      .draw-info {    margin-bottom: 10px;font-size: 14px;color: #999;background: url('../../../assets/img/personCenter/jinggao.png') no-repeat left center;padding-left:20px;line-height: 30px}
