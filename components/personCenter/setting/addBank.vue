...
-->
       ...
       <!-- <p >
          <span v-show="isName == 0"><nuxt-link to="/personCenter/setting" style="color:red">您还未实名，点击前往实名认证</nuxt-link></span>
...
<script>
  ...
  import {AddBank} from '../../../plugins/personCenterApi/personCenter'
  import {VerifyCode} from '../../../plugins/globalApi/global'
  import {JudgeSmsCode} from '../../../plugins/globalApi/global'
  export default {
    name: "addBank",
    layout:'left',
