<template>
    <div class="hot">
      <div class="news-r">
        ...
        <div class="box">
        <ul id="roll-ul">
            <nuxt-link @mouseover.native="clear1" @mouseout.native="start1"  :to="{name:'news-id',params:{id:item.Id}}" tag="li" v-for="(item,index) in hotList" :key="index"  :class="{anim:animate==true}">
