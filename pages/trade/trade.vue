   ...
   <div class="trade">
     <div class="inner-page-nav-wrap wrap">
       <div class="tradeNav">
         <div class="fl">
           <ul>
             <nuxt-link to="/myTrade/myTrade" tag="li">我的策略</nuxt-link>
       ...
       <div class="trade-content">
         ...
         <div class="form-submit-btn">
           ...
           <div v-show="nowType==31">
             ...
             <nuxt-link v-show="list.length!=0" :to="{path:'/myTrade/myTrade',query:{type:31}}" tag="button"  class="btn-standard btn-blue" :disabled="abled" >策略建议发起</nuxt-link>
           </div>
         </div>
       </div>
     </div>
...
<script>
  ...
  import {ProductDetail} from '../../plugins/trade/trade'
  import {CommitProduct} from '../../plugins/trade/trade'
  import {getProtocol} from '../../plugins/globalApi/global'
  import {ProductList} from '../../plugins/myTrade/myTrade'
  import {GetUserInfo} from '../../plugins/personCenterApi/personCenter'
