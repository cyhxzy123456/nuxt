     ...
     <div class="wrap">
       <div class="inner-page-nav-wrap wrap">
         <ul class="wrap clearfix inner-page-nav">
           <li  class="nav "><nuxt-link to="/myTrade/myTrade"> 我的策略</nuxt-link></li>
         </ul>
       </div>
       <div class="transport ">
         <div class="tranport_title">
          <span id="idd">{{hisTradeList.product_name}} ({{hisTradeList.borrowid}})</span>
         </div>
         <div class="tranport_content">
           ...
           <div class="history-title-wrap second easy_style45">
             ...
             <ul>
               <li><div>开始时间：<span >{{hisTradeList.date_begin  | dateString('YYYY-MM-DD')}}</span></div></li>
               <li><div>结束时间：<span>{{hisTradeList.date_end  | dateString('YYYY-MM-DD')}}</span></div></li>
               <li v-show="hisTradeList.product_type!=13"><div>委托人收益：<span v-text="parseFloat(borrowAnyInterest).toFixed(2)">13.2</span>元</div></li>
               <!--<i v-text="hisTradeList.product_type==12?'/交易月':''"></i>-->
               <li v-show="hisTradeList.product_type==13"><div>委托人收益：<span v-text="parseFloat(borrowAnyInterest).toFixed(2)">13.2</span>元</div></li>
             </ul>
           </div>
           <div class="history-title-wrap second easy_style45">
...
<script>
  import {SettleDetail} from '../../../plugins/myTrade/myTrade'
