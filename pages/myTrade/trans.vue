<template>
  <div class="content_main">
    <div class="wrap">
      <div class="trans">
        <p class="freeze" v-show="showFreeze">您的账号已被单向冻结，无法委托买入</p>
        <div v-show="type==31">
        ...
        <div class="transContent">
          ...
          <div class="rightCont">
            <div class="buy"  v-show="nowType == 0">
              ...
              <selfChoose ref="choose" :id="id"></selfChoose>
            </div>
            <!--            买入-->
...
<script>
  ...
  import {ProductDetailMom} from '../../plugins/myTrade/myTrade'//获取合约详情的状态
...
.freeze{color:#9c221f;padding-top:10px;text-align: center}
        ...
        .buy{overflow: hidden;
          .buyLeft{margin-right: 38px;
            li{margin-bottom: 20px;position: relative;
              ...
              button.delete{left:132px;border-bottom-left-radius: 5px;border-top-left-radius: 5px;background: url("../../assets/img/trade/del.png") no-repeat center #666}
              button.add{ border-bottom-right-radius: 5px;border-top-right-radius: 5px;background: url("../../assets/img/trade/add.png") no-repeat center #666}
          ...
          .buy-right{float:left;    width: 434px;
            .data-list{
              ...
              .center{
                span{line-height: 66px;padding-right: 40px;}
