    ...
    <div class="login-box">
      <div class="wrap clearfix">
        <div class="login-content fl">
          <h2 class="login-tit"><nuxt-link to="/login/login" class="go-reg">登录</nuxt-link></h2>
          <div class="login-inp">
            <label>
            ...
            <div class="remember">
             <div class="left fl">
              ...
              <nuxt-link to="/login/forgetPwd">忘记密码?</nuxt-link>
            </div>
...
<script>
  ...
  import {getUser} from '../../plugins/loginApi/login'
    export default {
      name: "login",
      ...
      mounted(){
        ...
        this.mobile =  String(localStorage.getItem('mobile'))
      },
    }
</script>
<style rel="stylesheet/less" lang="less" scoped>
  ...
  .login-code {display: inline-block;background: #fa7e41;width: 130px;
    line-height: 38px;text-align: center;color:#fff;background: url("../../assets/img/login/code-bg.png") no-repeat;vertical-align: top;
  }
  .login-box {background: url(../../assets/img/login/login-bg.png)no-repeat center;padding: 74px 0;
    .wrap{padding-left:186px;}
    .login-content {width: 415px;height:550px;padding: 40px 48px 120px;background: url(../../assets/img/login/login-cont-bg.png)no-repeat center;;margin: 0 auto;
      ...
      .login-inp {padding-top: 42px;
        ...
        .icon-user {display: inline-block;width: 40px;height: 40px;background: url(../../assets/img/login/user.png)no-repeat center;background-color: #fa7e41;}
        .icon-pwd {display: inline-block;width: 40px;height: 40px;background: url(../../assets/img/login/pwd.png)no-repeat center;background-color: #fa7e41;}
      }
      .login-menu {margin-top: 35px;}
      .btn-blue{background:  url(../../assets/img/login/login-btn.png)no-repeat center;display: block;height: 40px;width:100%;color:#fff}
