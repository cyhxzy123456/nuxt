...
<script>
  import {Cancle} from '../../plugins/personCenterApi/personCenter'//注销
  import {GetBankList} from '../../plugins/personCenterApi/personCenter'
...
<style  rel="stylesheet/less" lang="less" >
  .list label{display: block;margin-bottom: 20px;height: 44px;}
  .setting{
