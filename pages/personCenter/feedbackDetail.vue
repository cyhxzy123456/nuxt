<template>
    <div class="feedbackDetail">
      <div>
        <nuxt-link class="backList" tag="a" :to="{name:'personCenter-feedback',params:{cont:2}}">我的意见</nuxt-link>
      ...
      <p class="zj" v-if="show" @click="add" v-cloak>追加意见</p>
...
<script>
  ...
  import {Add} from '../../plugins/personCenterApi/personCenter'//追加
