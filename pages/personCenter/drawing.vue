<template>
    <div>
        <div class="drawing center-right">
          <div class="rightCont" v-show="this.$store.getters.config.validCash==0">
            <div class="recharge_leftBody">
              <div class="center-tit">可用资金：<span v-text="'￥'+userMoney.userBalance">￥96,232.56</span></div>
          ...
          <Close :name="name" :isOpen="this.$store.getters.config.validCash"></Close>
        </div>
